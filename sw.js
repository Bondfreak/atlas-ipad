const CACHE = "atlas-ipad-alpha-v0.3.18";
const ASSETS = ["./","./index.html","./manifest.json","./Hero-v2.png","./motor-system.png","./cooling-system.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
