const CACHE = "atlas-ipad-alpha-v0.3.0-epa0005";
const ASSETS = ["./","./index.html","./manifest.json","./Hero-v2.png","./cooling-system.svg","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
