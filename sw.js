const CACHE = "atlas-ipad-alpha-v0.3.2-epa0005-image-fix";
const ASSETS = ["./","./index.html","./manifest.json","./Hero-v2.png","./cooling-system.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
