const CACHE = "atlas-ipad-alpha-v0.3.14";
const ASSETS = ["./","./index.html","./manifest.json","./Hero-v2.png","./motor-system.png","./cooling-system.png","./epf-0032-clean.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
